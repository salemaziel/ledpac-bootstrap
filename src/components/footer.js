    ...
    <div className="inner">
      ...
      <ul className="icons bulleted">
        ...
        <li className="icon solid fa-envelope">
          <h3>Email</h3>
          <p><a href="#">info@ledpac.com</a></p>
        </li>
      </ul>
    </div>
  </div>
  <p className="copyright">© LEDPac. All rights reserved.<br />
    <a href="#">Terms of Use</a> | <a href="#">Privacy Policy</a> | <Link to="/contact">Contact</Link></p>
</footer>
