...
import UVCWandsReportsJapan from '../../../../assets/UV-C_wand_reports_merged_Japan.pdf'
...
const LSidebar = () => (
    ...
    <section>
        ...
        <p>Researchers at the Public Health Department in Japan tested UV-C LEDs and confirmed their ability to kill Covid-19. LEDpac LED systems complies to with their results.</p>
        <footer>
          <ul className="actions">
            <li><a href={UVCWandsReportsJapan} target="_blank" className="button">Learn More</a></li>
          </ul>
        </footer>
      </section>
       <hr />
