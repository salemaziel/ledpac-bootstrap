    ...
    <div className="box alt">
      <div className="row gtr-uniform gtr-50">
        ...
        <div className={uvcStyles.ProductBox}>
          ...
          <div className="col-7">
            <h3 className={uvcStyles.ProductTitle}>RGB LED</h3>
            <p>
        ...
        <div className={uvcStyles.ProductBox}>
          ...
          <div className="col-7">
            <h3 className={uvcStyles.ProductTitle}>Solar Powered LED</h3>
            <p>
              The new generation of LED light Chip-on-Board LEDs, also known as
              COBs, are the next and newst generation of LED lighting{" "}
            </p>
        ...
        <div className={uvcStyles.ProductBox}>
          ...
          <div className="col-7">
            <h3 className={uvcStyles.ProductTitle}>UltraViolet (UV) LED</h3>
            <p>
              The new generation of LED light Chip-on-Board LEDs, also known as
              COBs, are the next and newst generation of LED lighting{" "}
            </p>
